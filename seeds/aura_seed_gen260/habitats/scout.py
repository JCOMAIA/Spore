# -*- coding: utf-8 -*-
"""Scouting de habitats — fase 1 (sem LLM): catalogo curado de provedores com
...
PROVIDERS = [
    {
        ...
        "nome": "Oracle Cloud — Always Free (VM.Standard.E2.1.Micro / A1.Flex)",
        "custo": "R$ 0/mes",
...
def write_proposals():
    ...
    for p in PROVIDERS:
        ...
        with open(fn, "w", encoding="utf-8") as f:
            f.write("\n".join(lines) + "\n")
        n += 1
    print("[scout] %d propostas de lease em habitats/lease_proposals/ — aguardando SUA assinatura." % n)
    return n
